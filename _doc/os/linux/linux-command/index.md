...
modified_time: 2025-04-07 23:39
---
...
기본 명령어 | 운영체제에 기본으로 포함된 명령어로 독립적인 실행 파일로 존재함
시스템 호출 인터페이스 | 커널의 기능을 사용자 공간에서 접근할 수 있게 해주는 명령어
...
유형 | 디렉토리 | 설명
---|---|---
기본 명령어 | /bin, /sbin | 시스템 부팅이나 복구 등 필수 명령어
기본 명령어 (시스템 관리자) | /usr/sbin | 시스템 운영이나 관리에 필요한 명령어
기본 명령어 (일반 사용자) | /usr/bin | 배포판에서 기본으로 제공하는 명령어
