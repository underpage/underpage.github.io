...
modified_time: 2025-05-12 22:57
---

# Big Data
: 빅데이터는 기존의 데이터 처리 및 관리 도구로 효과적으로 다루기 어려운 대규모 데이터를 의미  
...
4차 | 지능화, 초연결 | 정보 기술, 지능 기술 | 실시간 데이터 처리, 대규모 데이터 분석 등
...
**데이터 엔지니어링 vs 빅데이터**  
: 빅데이터는 환경으로 데이터 엔지니어링은 빅데이터를 다루기 위한 핵심 기술
...
Veracity | 정확성, 일관성, 신뢰성 등 데이터의 품질
