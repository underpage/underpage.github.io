...
modified_time: 2025-09-20 03:19
---

# Security Standard
: 조직이 자산을 보호하고 보안 위험을 효과적으로 관리할 수 있도록 정립된 규정과 지침  
: 보안 거버넌스, 위험 관리, 컴플라이언스 준수를 위한 체계적인 방법론 제공  
...
국가 | AI 보안 가이드라인 | 과기정통부 | AI 및 빅데이터 활용 시 보안 기준
...
ISO/IEC 23053 | 사이버보안 프레임워크 | 사이버보안 관리를 위한 지침 표준
...
미국 | FedRAMP  | 클라우드 서비스 보안 인증 및 모니터링 
...
SOC 2 Type II + | SOC 2 평가 기준에 AI/ML 시스템 확장
