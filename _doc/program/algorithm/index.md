...
modified_time: 2025-02-28 19:56
---

# Algorithm
: 문제 해결을 위한 절차나 방법을 단계적으로 나열하고 이를 논리적으로 기술한 명세서  
: 컴퓨터는 스스로 문제를 해결할 수 없으며 문제를 해결하기 위한 명확한 지침이 필요함  
: 특정 문제 해결을 위한 알고리즘 설계 기법이 존재하며 일반적으로 이를 변형하거나 결합해 사용함  
...
- [알고리즘 설계](./algorithm-design.md)
  - [알고리즘 설계 전략](./algorithm-design-strategy.md)
  - [알고리즘 설계 기법](./algorithm-design-technique.md)
  - [알고리즘 분석](./algorithm-analysis.md)
- [알고리즘 분류](./classification/index.md)
- [알고리즘 문제 유형](./algorithm-problem.md)
