...
modified_time: 2025-12-03 02:38
---

# Python
: 1991년 귀도 반 로섬이 개발한 고급 프로그래밍 언어 및 생태계  
: PEP 프로세스를 통해 언어의 발전 방향과 새로운 기능 및 정책 등을 투명하고 체계적으로 관리함  
: [PyPI](./python-package-index/index.md)를 통해 서드파티 패키지를 제공하며 이를 관리하기 위한 패키지 관리 도구를 제공함  
: 가상 환경 도구를 통해 프로젝트별로 독립적인 실행 환경으로 구성하고 관리하여 의존성 충돌을 방지함  
...
- 파이썬 개발 도구
  ...
  - [테스팅 도구](./python-testing-tool.md)
  - [디버깅 및 프로파일링](./python-debugging-tool.md)
- [파이썬 개선 제안서](./pep.md)
  - [패키징 표준](./python-packaging.md)
  - [WSGI와 ASGI](./wsgi-and-asgi.md)
- [파이썬 표준 라이브러리](./python-standard-library/index.md)
  - [파이썬 내장 객체](./python-standard-library/builtin.md)
...
## Python Setup
: 다양한 설치 및 관리 도구들이 존재하며 단순 학습용이 아니라면 가상환경 구성이 필수임  

**system package manager**  
: 운영체제의 기본 패키지 관리자로 설치하는 방식  
: 간편하나 파이썬이 최신 버전이 아닐 수 있으며 시스템 전역으로 설치되어 의존성 문제가 있을 수 있음  
: 최신 리눅스 배포판은 전역 설치를 제한하고 있어 가상환경 구성이 필요함  

```bash
# Debian (Ubuntu, Kali, Mint 등)
sudo apt install python3 python3-pip python3-venv python3-dev

# Red Hat (RHEL, CentOS, Fedora, Rocky Linux 등)
...
**pyenv**  
: 파이썬 버전 관리 도구로 여러 버전의 파이썬을 동시에 설치하고 관리함  
...
**conda**  
: 가상 환경 및 패키지 관리 도구  
: conda만 단독 설치가 불가능하며 miniconda 또는 anaconda 설치를 통해 사용 가능함  
