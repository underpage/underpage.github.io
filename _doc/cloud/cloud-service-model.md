...
category: Cloud
title: 클라우드 서비스 모델
summary: IaaS·PaaS·SaaS 핵심 모델과 FaaS·CaaS 등 확장 모델의 정의, 책임 범위, 주요 사례
keywords:
- cloud
- cloud service model
- iaas
...
modified_time: 2026-05-18 00:53
---

{::comment}
ttl_tags: [cloud-service-model, iaas, paas, saas, faas, caas, daas, dbaas, aiaas, secaas, shared-responsibility-model, infrastructure-as-a-service, platform-as-a-service, software-as-a-service, function-as-a-service, container-as-a-service, serverless, managed-service, cloud-provider]
related:
- id: virtualization
  type: requires
- id: container
...
: 제공 업체와 사용자 간 책임 범위는 공유 책임 모델로 정의함  
...
**책임 공유 모델**  
: 책임 경계가 어떻게 달라지는지를 설명하는 메타 개념  
: IaaS > PaaS > SaaS로 갈수록 제공자 책임이 늘고 사용자 책임이 줄어듦  
